...
function renderTaskCard(t) {
  ...
  if (!t.done) {
    actions = t.started
      ...
      : `<div class="k-task-actions"><button class="kid-btn challenge" data-act="start" data-id="${t.id}"></button><button class="kid-btn" data-act="del" data-id="${t.id}">✕ 移除</button></div>`;
