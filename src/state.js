...
export const EMOJI_NAMES = {
  ...
  "✋": "手掌 / Raised Hand",
  "🖐": "五指张开 / Hand with Fingers Splayed",
  "🖖": "瓦肯举手礼 / Vulcan Salute",
  "👌": "OK手势 / OK Hand",
  "🤌": "捏手指 / Pinched Fingers",
  "🤏": "捏一捏 / Pinching Hand",
  ...
  "⛹": "打篮球 / Person Bouncing Ball",
  "🏋": "举重 / Person Lifting Weights",
  "🤼": "摔跤 / Wrestlers",
  "🏌": "打高尔夫 / Person Golfing",
  "🎿": "滑雪 / Skier",
  "🏂": "单板滑雪 / Snowboarder",
  ...
  "🪵": "木头 / Wood",
  "☀": "太阳 / Sun",
  "🌤": "晴转多云 / Sun Behind Small Cloud",
  "⛅": "多云转晴 / Sun Behind Cloud",
  "🌥": "多云 / Sun Behind Large Cloud",
  "☁": "云 / Cloud",
  "🌦": "晴转雨 / Sun Behind Rain Cloud",
  "🌧": "下雨 / Cloud with Rain",
  "⛈": "雷暴 / Cloud with Lightning and Rain",
  "🌩": "打雷 / Cloud with Lightning",
  "🌨": "下雪 / Cloud with Snow",
  "❄": "雪花 / Snowflake",
  "☃": "雪人 / Snowman",
  ...
  "⬇": "下箭头 / Down Arrow",
  "↗": "右上箭头 / Up-Right Arrow",
  "↘": "右下箭头 / Down-Right Arrow",
  "↙": "左下箭头 / Down-Left Arrow",
  "↖": "左上箭头 / Up-Left Arrow",
  "↕": "上下箭头 / Up-Down Arrow",
  ...
  "🔝": "顶部 / Top Arrow",
  "✝": "十字架 / Latin Cross",
  "☦": "东正教十字 / Orthodox Cross",
  "☪": "星月 / Star and Crescent",
  "🕉": "欧姆 / Om",
  "✡": "大卫之星 / Star of David",
  "☸": "法轮 / Wheel of Dharma",
  "♈": "白羊座 / Aries",
  ...
  "▪": "黑小方块 / Black Small Square",
  "▫": "白小方块 / White Small Square",
  "♾": "无限 / Infinity",
  "✖": "乘号 / Multiply",
  "➕": "加号 / Plus",
  "➖": "减号 / Minus",
  ...
  "✳": "星号 / Eight-Spoked Asterisk",
  "✴": "八角星 / Eight-Pointed Star",
  "❇": "闪烁 / Sparkle",
  "💢": "愤怒符号 / Anger Symbol",
  "💬": "对话气泡 / Speech Balloon",
  "💭": "思考气泡 / Thought Balloon",
  "🗨": "左对话泡 / Left Speech Bubble",
  "🗯": "愤怒对话泡 / Right Anger Bubble",
  "💤": "呼噜 / Zzz",
  "💈": "理发店转灯 / Barber Pole",
  "🎏": "鲤鱼旗 / Carp Streamer",
  "🎐": "风铃 / Wind Chime",
  ...
  "0⃣": "数字0 / Keycap Digit Zero",
  "1⃣": "数字1 / Keycap Digit One",
  "2⃣": "数字2 / Keycap Digit Two",
  "3⃣": "数字3 / Keycap Digit Three",
  "4⃣": "数字4 / Keycap Digit Four",
  "5⃣": "数字5 / Keycap Digit Five",
  "6⃣": "数字6 / Keycap Digit Six",
  "7⃣": "数字7 / Keycap Digit Seven",
  "8⃣": "数字8 / Keycap Digit Eight",
  "9⃣": "数字9 / Keycap Digit Nine",
  "🔟": "数字10 / Keycap 10",
  "#⃣": "井号键 / Keycap Number Sign",
  "*⃣": "星号键 / Keycap Asterisk",
  "ℹ": "信息 / Information",
  "🆗": "OK / OK Button",
  "🆕": "新 / NEW Button",
  "🆙": "升级 / UP! Button",
...
export async function loadState() {
  ...
  for (const p of state.todoProjects) {
    ...
    if (p.notes == null) p.notes = ''; // 项目备注(补丁·50)
    if (p.deadline == null) p.deadline = 0; // 项目截止时间(补丁·50)
  ...
  // 确保「常用」emoji 分组存在并置顶(允许与别的分类重复;右键菜单可加入)
  getFavIconGroupId();
}
...
export function iconEmojiKey(e) {
  return String(e || '').replace(/️/g, '');
}

/** 「常用」emoji 分组固定 id:允许与别的分类重复,右键可加入。固定 id 便于稳定识别。 */
export const ICON_FAV_GROUP_ID = '__icon_fav__';

/** 取得(必要时创建并置顶)「常用」emoji 分组 id;返回固定 id 字符串 */
export function getFavIconGroupId() {
  const groups = getIconGroups();
  let g = groups.find((x) => x.id === ICON_FAV_GROUP_ID);
  if (!g) {
    g = { id: ICON_FAV_GROUP_ID, name: '常用', sort: -1 };
    groups.unshift(g);
    commitIconLib();
  } else if (groups[0] !== g) {
...
export function mergeDefaultIconLibrary() {
  ...
  // 注意:「常用」分组允许与别的分类重复,故不参与全局去重(既不标记删除,也不登记 seen)
  const seen = new Map();
  for (const it of items) {
    if (isImageIcon(it.icon)) continue;
    if (it.groupId === ICON_FAV_GROUP_ID) continue;
